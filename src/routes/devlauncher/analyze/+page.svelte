...
<style>
  ...
  .hint { color: #aaa; font-size: 0.85rem; margin: 0.75rem 0 0; }
  .msg { margin-top: 0.75rem; padding: 0.6rem 1rem; border-radius: 8px; font-size: 0.9rem; }
  ...
  .desc { color: #888; font-size: 0.85rem; margin: 0.15rem 0 0; }
  ...
  .add-menu-item:hover { background: #f5f5ff; }

  .add-icon { font-size: 1.1rem; }

  .add-menu-item div { display: flex; flex-direction: column; }

  .add-menu-item strong { font-weight: 600; font-size: 0.9rem; }

  .add-desc { font-size: 0.75rem; color: #999; }
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .picker-card { background: #0f0f0f98; border-color: #444; }
    .path-display { background: #2a2a2a; color: #ccc; }

    .action-card { background: #0f0f0f98; border-color: #444; }
    .card-editor { background: #1a1a1a; border-top-color: #444; }
    .field label { color: #aaa; }
    .field input, .field select, .field textarea { background: #2a2a2a; border-color: #555; color: #eee; }
    .field input:focus, .field select:focus, .field textarea:focus { border-color: #5b8def; }

    .toggle-btn { background: #2a2a2a; border-color: #555; color: #888; }
    .toggle-btn.on { background: #1b3a1b; border-color: #2e7d32; color: #81c784; }

    .icon-btn { border-color: #444; color: #888; }
    .icon-btn:hover { background: #333; color: #eee; }

    .add-btn { border-color: #555; color: #888; }
    .add-btn:hover { border-color: #5b8def; color: #5b8def; background: #1a1a3e; }

    .add-menu { background: #1e1e1e; border-color: #444; }
    .add-menu-item:hover { background: #2a2a3e; }
