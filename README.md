...
> **Статус:** активная open-source разработка. Полностью бесплатно.
...
StackPilot поддерживает **Windows, Linux и macOS** (x64/arm64).
...
Репозиторий содержит исходники. Бинарные сборки появятся в разделе [Releases](https://github.com/cheburek4535/StackPilot/releases) — скачивайте только оттуда и проверяйте checksum.
